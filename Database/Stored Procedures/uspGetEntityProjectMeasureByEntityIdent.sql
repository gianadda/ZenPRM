IF EXISTS (select * from dbo.sysobjects where id = object_id(N'uspGetEntityProjectMeasureByEntityIdent') 
	AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE uspGetEntityProjectMeasureByEntityIdent
GO

/* uspGetEntityProjectMeasureByEntityIdent 306485, 306487, 1
 *
 *
 *
 *
*/
CREATE PROCEDURE uspGetEntityProjectMeasureByEntityIdent
