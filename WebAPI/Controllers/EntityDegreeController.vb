...
Public Class EntityDegreeController
    ...
    Public Function post(putObject As JObject)
        ...
        Try
            ...
            slParameters.Add("DegreeIdent", CType(putObject("DegreeIdent"), Int64))
            slParameters.Add("AddASUserIdent", Helper.AddEditASUserIdent)
            slParameters.Add("Active", CBool(putObject("Active")))

            If Helper.SQLAdapter.GetDataSet(Helper.ApplicationName, Helper.AddEditASUserIdent, "uspAddEntityDegreeXRef", slParameters, False, dsResults, dsMessage) Then
    ...
    Public Function Delete(putObject As JObject)
        ...
        Try
            ...
            If Helper.SQLAdapter.GetDataSet(Helper.ApplicationName, Helper.AddEditASUserIdent, "uspDeleteEntityDegreeXRefByIdent", slParameters, False, dsResults, dsMessage) Then
