...
Public Class EntitySpecialityController
    ...
    Public Function post(putObject As JObject)
        ...
        Try
            ...
            slParameters.Add("SpecialityIdent", CType(putObject("SpecialityIdent"), Int64))
            slParameters.Add("AddASUserIdent", Helper.AddEditASUserIdent)
            slParameters.Add("Active", CBool(putObject("Active")))

            If Helper.SQLAdapter.GetDataSet(Helper.ApplicationName, Helper.AddEditASUserIdent, "uspAddEntitySpecialityXRef", slParameters, False, dsResults, dsMessage) Then
    ...
    Public Function Delete(putObject As JObject)
        ...
        Try
            ...
            If Helper.SQLAdapter.GetDataSet(Helper.ApplicationName, Helper.AddEditASUserIdent, "uspDeleteEntitySpecialityXRefByIdent", slParameters, False, dsResults, dsMessage) Then
