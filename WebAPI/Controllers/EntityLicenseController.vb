...
Public Class EntityLicenseController
    ...
    Public Function post(putObject As JObject)
        ...
        Try
            ...
            slParameters.Add("StatesIdent", CType(putObject("StatesIdent"), Int64))
            slParameters.Add("LicenseNumber", CType(putObject("LicenseNumber"), String))
            slParameters.Add("LicenseNumberExpirationDate", CType(putObject("LicenseNumberExpirationDate"), String))
            slParameters.Add("AddASUserIdent", Helper.AddEditASUserIdent)
            slParameters.Add("Active", CBool(putObject("Active")))

            If Helper.SQLAdapter.GetDataSet(Helper.ApplicationName, Helper.AddEditASUserIdent, "uspAddEntityLicense", slParameters, False, dsResults, dsMessage) Then
    ...
    Public Function Put(putObject As JObject)
        ...
        Try
            ...
            If Helper.SQLAdapter.GetDataSet(Helper.ApplicationName, Helper.AddEditASUserIdent, "uspEditEntityLicenseByIdent", slParameters, False, dsResults, dsMessage) Then
    ...
    Public Function Delete(putObject As JObject)
        ...
        Try
            ...
            If Helper.SQLAdapter.GetDataSet(Helper.ApplicationName, Helper.AddEditASUserIdent, "uspDeleteEntityLicenseByIdent", slParameters, False, dsResults, dsMessage) Then
