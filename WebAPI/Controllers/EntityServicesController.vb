...
Public Class EntityServicesController
    ...
    Public Function post(putObject As JObject)
        ...
        Try
            ...
            slParameters.Add("Services1Ident", CType(putObject("ServicesIdent"), Int64))
            slParameters.Add("AddASUserIdent", Helper.AddEditASUserIdent)
            slParameters.Add("Active", CBool(putObject("Active")))

            If Helper.SQLAdapter.GetDataSet(Helper.ApplicationName, Helper.AddEditASUserIdent, "uspAddEntityServices1XRef", slParameters, False, dsResults, dsMessage) Then
    ...
    Public Function Delete(putObject As JObject)
        ...
        Try
            ...
            If Helper.SQLAdapter.GetDataSet(Helper.ApplicationName, Helper.AddEditASUserIdent, "uspDeleteEntityServices1XRefByIdent", slParameters, False, dsResults, dsMessage) Then
